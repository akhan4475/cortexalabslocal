...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[1400px] -mt-12 mx-auto h-[40rem] md:h-[60rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-black md:rounded-2xl p-2 md:p-4 border border-white/10">
        {children}
      </div>
    </motion.div>
  );
